...
Функционал: Заполнение тестовых данных документа Заказ

Контекст:
	Дано Я запускаю сценарий открытия TestClient или подключаю уже существующий

@ТипШага: Загрузка данных
@Описание: Заполнение тестовых данных документа Заказ
@ПримерИспользования: И заполнение тестовых данных документа Заказ
Сценарий: Заполнение тестовых данных документа Заказ
